...
![image-20220215214803041](https://cdn.jsdelivr.net/gh/duskdusts/blog@latest/img/image-20220215214803041.png)
...
2. websaver中安装包写对应的配置文件便于操作，使用aliyun-webdav、caiyun-webdav、rclone copy

遇到的一些问题

- [ ] rclone copy 命令无法复制删除操作
